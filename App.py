...
def main ():
    op = st.sidebar.selectbox(label = "Eliga un apartado", options = ["Formulario","Leer"], key = 'Eliga un apartado --usuario')
    ...
    if op == "Formulario":
        ...
        st.dataframe(data = hoja.leer(), key = 'Data frame --usuario')
